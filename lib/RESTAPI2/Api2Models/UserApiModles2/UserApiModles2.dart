...
UserApiModles2 userApiModles2FromJson(String str) => UserApiModles2.fromJson(json.decode(str));
String userApiModles2ToJson(UserApiModles2 data) => json.encode(data.toJson());
class UserApiModles2 {
  UserApiModles2({
      num? id, 
      String? name, 
      String? username, 
  ...
  UserApiModles2.fromJson(dynamic json) {
    _id = json['id'];
    _name = json['name'];
  ...
  String? _website;
  Company? _company;
UserApiModles2 copyWith({  num? id,
  String? name,
  String? username,
  String? email,
  Address? address,
